...
class Scalar:
    ...
    def chain_rule(self, d_output: Any) -> Iterable[Tuple[Variable, Any]]:
        ...
        associated_var_list = h.inputs
        # print('type of h.last_fn.backward(h.ctx, d_output)')
        # print(type(h.last_fn.backward(h.ctx, d_output)))
        ...
        result = list(zip(associated_var_list, derivative_list))

        # print('associated_vars')
        # print('type associated_vars')
        # print(type(associated_var_list))
        # print('content associated_vars')
        # print(associated_var_list)

        # print('derivatives')
        # print('type derivative')
        # print(type(derivative_list))
        # print('content derivative')
