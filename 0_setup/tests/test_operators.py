...
def test_sigmoid(a: float) -> None:
    ...
    * It is  strictly increasing.
    ...
    if (sigmoid(a) < 0.0) or (sigmoid(a) > 1.0):
        raise ValueError("Sigmoid is out of its proper range of 0.0 to 1.0")
    elif (sigmoid(a) * (1 - sigmoid(a))) < 0:
        raise ValueError("Sigmoid violated the property of being strictly increasing")
    elif a == 0.0:
        assert_close(sigmoid(a), 0.5)
    else:
        assert_close(sigmoid(a), (1 - sigmoid(-1.0 * a)))
...
def test_other(a: float, b: float, c: float) -> None:
    ...
    # TODO: Implement for Task 0.2.
    # raise NotImplementedError("Need to implement for Task 0.2")
    # verifying associative property for multiplication
